...
namespace WaocLib
{
    public class Constantes
    {
        ...
        public const int NULLENTIER = -int.MaxValue;
        public const string NULLCHAINE = "NAZE";
        ...
        public const int CST_DISTANCE_FORUM = 2;//distance en km où l'on peut se parler en direct
