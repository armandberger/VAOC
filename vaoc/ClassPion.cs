            ...
            internal bool Rencontre(Donnees.TAB_PIONRow lignePionEnnemi, Donnees.TAB_CASERow ligneCase)
            {
                ...
                if (!Donnees.m_donnees.TAB_PARTIE.Nocturne())
                {
                    ...
                    if (!estArtillerie && !lignePionEnnemi.estArtillerie)
                    {
                        ...
                        bool btest1 = estCombattifQG(false, false);
                        bool betest1 = lignePionEnnemi.estCombattifQG(false, true);
                        bool btest2 = estCombattifQG(false, true);
                        bool betest2 = lignePionEnnemi.estCombattifQG(false, false);
