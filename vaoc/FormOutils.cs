            ...
            if (DialogResult.Yes == MessageBox.Show("Etes vous certains de vouloir importer ces tables ? Toutes les données précédentes seront détruites", "Demande de Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
            {
                try
                {
                    foreach (string element in this.listBoxImport.SelectedItems)
                    {
                        ...
                        lignePion = ((Donnees.TAB_PIONDataTable)donneesImport.Tables[nomTable]).FindByID_PION(9250);
                        ((Donnees.TAB_PIONDataTable)Donnees.m_donnees.Tables[nomTable]).AddTAB_PIONRow(
                        lignePion.ID_PION,
                        ...
                        lignePion.I_TOUR_DERNIER_RAVITAILLEMENT_DIRECT,
                        lignePion.I_VICTOIRE,
                        lignePion.I_TRI,
                        lignePion.S_ENNEMI_OBSERVABLE,
                        Constantes.NULLENTIER//lignePion.I_TOUR_ENNEMI_OBSERVABLE
                        );
                        lignePion = ((Donnees.TAB_PIONDataTable)donneesImport.Tables[nomTable]).FindByID_PION(9251);
                        ((Donnees.TAB_PIONDataTable)Donnees.m_donnees.Tables[nomTable]).AddTAB_PIONRow(
                        lignePion.ID_PION,
                        lignePion.ID_MODELE_PION,
                        lignePion.ID_PION_PROPRIETAIRE,
                        ...
                        lignePion = ((Donnees.TAB_PIONDataTable)donneesImport.Tables[nomTable]).FindByID_PION(9252);
                        ((Donnees.TAB_PIONDataTable)Donnees.m_donnees.Tables[nomTable]).AddTAB_PIONRow(
                        lignePion.ID_PION,
                        lignePion.ID_MODELE_PION,
                        lignePion.ID_PION_PROPRIETAIRE,
                        ...
                        lignePion = ((Donnees.TAB_PIONDataTable)donneesImport.Tables[nomTable]).FindByID_PION(9253);
                        ((Donnees.TAB_PIONDataTable)Donnees.m_donnees.Tables[nomTable]).AddTAB_PIONRow(
                        lignePion.ID_PION,
                        lignePion.ID_MODELE_PION,
                        lignePion.ID_PION_PROPRIETAIRE,
                        ...
                        lignePion = ((Donnees.TAB_PIONDataTable)donneesImport.Tables[nomTable]).FindByID_PION(10373);
                        ((Donnees.TAB_PIONDataTable)Donnees.m_donnees.Tables[nomTable]).AddTAB_PIONRow(
                        lignePion.ID_PION,
                        lignePion.ID_MODELE_PION,
                        lignePion.ID_PION_PROPRIETAIRE,
