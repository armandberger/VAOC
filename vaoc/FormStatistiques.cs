...
namespace vaoc
{
    public partial class FormStatistiques : Form
    {
        ...
        private void FormStatistiques_Load(object sender, EventArgs e)
        {
            ...
            {
                if (lignePion.estJoueur || lignePion.ID_PION==30 || lignePion.ID_PION == 80 || lignePion.ID_PION == 140 || lignePion.ID_PION == 240 || lignePion.ID_PION == 300 || lignePion.ID_PION == 310 || lignePion.ID_PION == 320)
                {
