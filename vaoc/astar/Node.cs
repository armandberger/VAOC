...
namespace vaoc
{
	...
	public class Node
	{
        ...
        public Donnees.TAB_CASERow Position
		{
			set
			{
        ...
        //public static double MouvementCostHeuristic(Node N1, Node N2)
        //{
        //    if ( N1==null || N2==null ) throw new ArgumentNullException();
        //    // le cout depend du type de mouvement utilisé et de la météo
        //    double cout;
        //    cout = DataSetCoutDonnees.m_donnees.TAB_MOUVEMENT_COUT.CalculCout(AStar.SearchIdMeteo, N2.Position.ID_MODELE_TERRAIN, AStar.SearchIdModeleMouvement);
        //    return cout;
        //}
