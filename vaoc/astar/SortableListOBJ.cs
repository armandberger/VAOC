...
namespace vaoc
{
	...
	public class SortableListOBJ : IList, ICloneable
	{
        ...
        //private Hashtable _Htable;//tentative d'accélération du traitement !

		/// <summary>
		/// Default constructor.
		/// Since no IComparer is provided here, added objects must implement the IComparer interface.
		/// </summary>
		public SortableListOBJ() { InitProperties(null, 0); }
		...
		public SortableListOBJ(int Capacity) { InitProperties(null, Capacity); }

		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="Comparer">Will be used to compare added elements for sort and search operations.</param>
		public SortableListOBJ(IComparer Comparer) { InitProperties(Comparer, 0); }
		...
		/// <param name="Comparer">Will be used to compare added elements for sort and search operations.</param>
		/// <param name="Capacity">Capacity of the list (<see cref="ArrayList.Capacity">ArrayList.Capacity</see>)</param>
		public SortableListOBJ(IComparer Comparer, int Capacity) { InitProperties(Comparer, Capacity); }
        ...
        {
            TrackOBJ t = (TrackOBJ)_List[Index];
            _ListCout.Remove(t);
		...
		public object Clone()
		{
			SortableListOBJ Clone = new SortableListOBJ(_Comparer, _List.Capacity);
        ...
        public int IndexOf(TrackOBJ O, Equality AreEqual)
		{
            int Result = -1;
            if (_IsSorted)
            {
        ...
        */
        ...
        private class ComparisonCase : IComparer
        {
            ...
            {
                int valA, valB;
                valA = (null != ((TrackOBJ)a).EndNode) ? ((TrackOBJ)a).EndNode.ID_CASE : ((TrackOBJ)a).EndNodeHPA.ID_CASE_FIN;
                valB = (null != ((TrackOBJ)b).EndNode) ? ((TrackOBJ)b).EndNode.ID_CASE : ((TrackOBJ)b).EndNodeHPA.ID_CASE_FIN;
        ...
        private class ComparisonCout : IComparer
        {
            ...
            public int Compare(object a, object b)
            {
                return (int)(((TrackOBJ)a).Cost - ((TrackOBJ)b).Cost);
            }
        }
